...
export default function GalleryWidget() {
  ...
  return (
    <div className="bg-gray-800/70 backdrop-blur-sm rounded-3xl shadow-2xl shadow-black/50 border border-gray-700/50 transition-all duration-500 hover:shadow-3xl hover:border-gray-600/60 dark-hover-shadow">
      {/* Top section with question mark icon, gallery button and controls */}
      <div className="px-8 pt-6 pb-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <HelpCircle size={22} className="text-gray-500 flex-shrink-0 transition-all duration-300 hover:text-gray-300 hover:rotate-12 cursor-pointer" />
