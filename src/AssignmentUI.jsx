...
export default function AssignmentUI() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-zinc-900 to-neutral-900 text-gray-100 font-sans">
      <style>{`
        @keyframes fadeIn {
          from { 
            opacity: 0; 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
        {/* Empty left column for desktop layout */}
        ...
        <div className="flex flex-col justify-center gap-6 p-8 lg:pr-12">
          ...
          <div className="relative w-full h-px">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-gray-300 to-transparent blur-sm opacity-50"></div>
          </div>
